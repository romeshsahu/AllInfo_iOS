...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		_progress = 0.f;
		_annular = NO;
		_progressTintColor = [[UIColor alloc] initWithRed:(179/255.f) green:(6/255.f) blue:(33/255.f) alpha:1.0f];
//        [[UIColor colorWithRed:(170/255.f) green:(170/255.f) blue:(170/255.f) alpha:1.0f]CGColor]
