...
CGFloat const kTWMessageBarManagerDisplayDelay = 5.0f;//pp change notification display time
...
NSString * const kTWMessageBarStyleSheetImageIconInfo = @"allInfoIcon.png";//@"icon-info.png";
